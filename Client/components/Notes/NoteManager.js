...
class NoteManager extends Component {
    ...
    render() {
        return (
            <div>                                
                <Modal isOpen={this.state.isAddNoteModalOpen}   ariaHideApp={false} onRequestClose={this.handleOnCloseAddNoteModal}>
                    <AddNoteForm onSaveNote={this.handleOnAddNote} onCloseModal={this.handleOnCloseAddNoteModal} />
                </Modal>
                <Modal isOpen={this.state.isEditNoteModalOpen}   ariaHideApp={false} onRequestClose={this.handleOnCloseEditNoteModal}>
